...
function multiply(a, b) { //eslint-disable-line
  let mySum = a*b;
  let myStr = `The product of ${a} and ${b} is ${mySum}.`;
  return [mySum, myStr];
}
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  let sum1 = (sum(a,b)[0]);
  let fsum = (sum(sum1, c)[0]);
  let pro1 = (multiply(a,b)[0]);
  let fpro = (multiply(pro1, c)[0]);
  let sstr = `${a} and ${b} and ${c} sum to ${fsum}.`
  let pstr = `The product of ${a} and ${b} and ${c} is ${fpro}.`
  return [fsum, fpro, sstr, pstr]
}
